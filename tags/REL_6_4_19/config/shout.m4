...
dnl 
dnl $Id: shout.m4,v 1.1 2011/04/12 19:16:34 pafe Exp $
...
AC_ARG_WITH([libshout],
	[  --with-libshout[[=PATH]]     Prefix where libshout is installed (optional)],
	[libshout_prefix="$withval"],
	[libshout_prefix="no"])
	
	AC_MSG_CHECKING(if libshout should be included)
